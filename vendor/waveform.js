(function() {
  ...
  window.Waveform = Waveform = (function() {
    ...
    Waveform.prototype.redraw = function() {
      ...
      this.clear();
      if (typeof this.innerColor === "fcunction") {
          ...
          if (!innerColorWasSet) {
            ...
            that.innerColor = function(x, y) {
              if (x < stream.position / stream.durationEstimate) {
                return options.playedColor || "rgba(255,  102, 0, 1)";
              } else if (x < stream.bytesLoaded / stream.bytesTotal) {
                return options.loadedColor || "rgba(128, 128, 128, 1)";
              } else {
                return options.defaultColor || "rgba(92, 92, 92, 1)";
              }
            };
